---
title: "Nutrition and Molecular Genetic Research - People"
layout: gridlay
excerpt: "cancerprevention: Group members"
sitemap: false
permalink: /people/
---
 ...
 **<font color="red"> We are  looking for new <a href="https://person.zju.edu.cn/en/jieyang#openings">Postdocs</a>! </font>**
...
<div class="col-sm-6 clearfix">
  ...
  <h4><a href ="{{ member.personweb }}"> {{ member.name }}</h4>
...
{% for member in site.data.assistant %}
